...
class ConstructorTest: XCTestCase {
    ...
    func test1() {
        ...
        XCTAssertEqual(x1._magnitude.count, 1)
        XCTAssertFalse((x1.isNegative))
        let x2 = BInt("-0", radix: 10)!
        XCTAssertEqual(x2._magnitude.count, 1)
        ...
        let x6 = BInt("-123")!
        XCTAssertEqual(x6._magnitude[0], 123)
    ...
    func test2() {
        ...
        let x1 = BInt(1)
        let xm1 = BInt(-1)
        XCTAssertEqual(x0._magnitude.count, 1)
        XCTAssertEqual(x1._magnitude.count, 1)
        XCTAssertEqual(xm1._magnitude.count, 1)
